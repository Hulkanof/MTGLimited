...
def new_limited(set_name: str, player: int, number: int, output: click.Path, force_unbalanced: bool) -> None:
    """
...
def limited(set_name: str, player: int, number: int, output: click.Path, force_unbalanced: bool) -> None:
    """
    ...
    """
    new_limited(set_name, player, number, output, force_unbalanced)
